...
//    UILongPressGestureRecognizer *longPrssGR = [[UILongPressGestureRecognizer alloc]initWithTarget:self action:@selector(lpGR:)];
//    longPrssGR.minimumPressDuration = 1;
//    [cell addGestureRecognizer:longPrssGR];
//    return cell;
    return cell;
}
